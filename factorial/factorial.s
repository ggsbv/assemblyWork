...
#          The factorial of 4 is 4*3*2*1, or 24.
...
_start:
  pushl $4              # The factorial takes on argument - the
                        # number we want a factorial of. So, it gets pushed
  call factorial
...
factorial:
  ...
  cmpl $1, %eax         # If the number is 1, that is our base
                        # case, and we simply return (1 is already in %eax
                        # as the return value)
  je end_factorial
...
end_factorial:
  movl %ebp, %esp       # we have to restore %ebp and %esp to where they
  popl %ebp             # they were before the function started
  ret                   # return to the function (this pops the return value)
